package about.nocare.casaer.satanwang.widget.appmore.ar;
...
public class SimpleProgressbar extends ProgressBar {
    ...
    public static final int DEFAULT_UNREACHED_COLOR = Color.parseColor("#F2F3F8");
    public static final int DEFAULT_REACHED_COLOR = Color.parseColor("#5D76EC");
