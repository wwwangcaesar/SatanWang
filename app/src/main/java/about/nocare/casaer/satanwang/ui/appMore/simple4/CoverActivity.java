...
public class CoverActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mTransitionsContainer = (ViewGroup)findViewById(R.id.container_layout);
        initial();
    }
    ...
    private void initial() {
        ...
        if (rect != null) {
            ...
            Picasso.with(CoverActivity.this)
                    .load(mCoverUrl)
            ...
            Picasso.with(CoverActivity.this).load(mCoverUrl).into(mIvCover);
        }
    }
