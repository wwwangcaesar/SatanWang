package about.nocare.casaer.satanwang.db;
 ...
 * 晕了很久才明白见execSQL的源码注释 (Multiple statements separated by is are not supported.)
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static String DB_PATH = "/data/data/about.nocare.casaer.satanwang/databases/";
    /*
