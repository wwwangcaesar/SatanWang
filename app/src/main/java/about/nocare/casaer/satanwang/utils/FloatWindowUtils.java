...
import about.nocare.casaer.satanwang.utils.rom.HuaweiUtils;
import about.nocare.casaer.satanwang.utils.rom.MeizuUtils;
import about.nocare.casaer.satanwang.utils.rom.MiuiUtils;
import about.nocare.casaer.satanwang.utils.rom.QikuUtils;
import about.nocare.casaer.satanwang.utils.rom.RomUtils;

/**
*      全app 存在的悬浮框
* @author Satan Wang
* created at 2018/7/6 10:53
*/
...
public class FloatWindowUtils {
    ...
    private static boolean commonROMPermissionCheck(Context context) {
        //最新发现魅族6.0的系统这种方式不好用，没办法，单独适配一下
    ...
    private static void showConfirmDialog(final Context context, String message, final OnConfirmResult result) {
