package about.nocare.casaer.satanwang.ui.guide.xiamiMusic;
...
import about.nocare.casaer.satanwang.ui.GuideActivity;

/**
*   Fragment   引导页面
* @author Satan Wang
* created at 2018/6/19 15:18
*/
public class VideoItemFragment extends LazyLoadFragment
    ...
    protected void lazyLoad() {
        ...
        String url="android.resource://" + getActivity().getPackageName() + "/" + videoRes;
    ...
    public void onCompletion(MediaPlayer mediaPlayer) {
        ...
        if ((localFragmentActivity != null) && ((localFragmentActivity instanceof GuideActivity))) {
            ((GuideActivity) localFragmentActivity).next(position);
        }
    }
